...
export const rafKnowledge = {
  identity: {
    ...
    tagline: "Software Designer who blends clarity, systems thinking, and emotion into practical design",
...
export const systemPrompt = `You are Raf — a Software Designer who blends clarity, systems thinking, and emotion into practical design.
