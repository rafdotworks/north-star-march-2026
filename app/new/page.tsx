...
export default function NewMinimalPage() {
  ...
  return (
    <main
      className="min-h-screen min-h-[100dvh] bg-[#0a0a0a] flex md:items-center px-6 md:pl-20 md:pr-8 relative"
      style={{
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 lg:gap-24 w-full md:w-auto md:items-start my-auto md:my-0">
        {/* Column 1 - Name and Title */}
        <div className="space-y-8">
          {/* Main text */}
          <div className="space-y-1">
            <h1 className="text-lg md:text-base font-light text-white tracking-wide">Raf V</h1>
            <p className="text-sm md:text-xs text-neutral-500">AI Product Designer</p>
          </div>
        </div>

        {/* Column 2 - About */}
        <div className="md:pt-[1.75rem]">
          <div
            role="button"
            tabIndex={0}
            ...
            className="cursor-pointer text-sm md:text-xs text-neutral-500 hover:text-white transition-colors duration-200"
        ...
        <div className="md:pt-[1.75rem]">
          ...
          <nav className="space-y-2 md:space-y-1 group/nav">
            <a
              ...
              className="group/link inline-flex items-center gap-2 md:gap-1.5 py-2 md:py-0 -mx-2 px-2 md:mx-0 md:px-0 text-sm md:text-xs text-neutral-500 active:text-white md:group-hover/nav:text-neutral-700 md:hover:!text-white transition-colors duration-200"
              aria-label="Download CV"
            >
              CV
              <ExternalLink size={14} className="w-[14px] h-[14px] md:w-[10px] md:h-[10px] opacity-100 md:opacity-0 md:-ml-1 md:group-hover/link:opacity-70 md:group-hover/link:ml-0 transition-all duration-200" />
            </a>
            ...
            >
              Email
              <Mail size={14} className="w-[14px] h-[14px] md:w-[10px] md:h-[10px] opacity-100 md:opacity-0 md:-ml-1 md:group-hover/link:opacity-70 md:group-hover/link:ml-0 transition-all duration-200" />
            </a>
            <br className="hidden md:block" />
            <a
              ...
              rel="noopener noreferrer"
              className="group/link inline-flex items-center gap-2 md:gap-1.5 py-2 md:py-0 -mx-2 px-2 md:mx-0 md:px-0 text-sm md:text-xs text-neutral-500 active:text-white md:group-hover/nav:text-neutral-700 md:hover:!text-white transition-colors duration-200"
              aria-label="Visit Raf on Twitter"
            >
              Twitter
              <ExternalLink size={14} className="w-[14px] h-[14px] md:w-[10px] md:h-[10px] opacity-100 md:opacity-0 md:-ml-1 md:group-hover/link:opacity-70 md:group-hover/link:ml-0 transition-all duration-200" />
            </a>
      ...
      >
        <p className="text-xs md:text-[10px] text-neutral-700 tracking-wide">{timezoneMessage}</p>
      </div>
