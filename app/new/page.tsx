...
export default function NewMinimalPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start flex-1 md:flex-none md:grid md:grid-cols-3 md:gap-20 w-full md:w-auto md:items-baseline md:my-0 px-8 md:px-0">
        ...
        <div className="relative flex flex-col items-start md:items-start md:relative mb-12 md:mb-0">
          ...
          <p className="text-xs md:text-xs text-muted-foreground leading-[1.5] transition-colors duration-200">AI Product Designer</p>
        </div>
        ...
        <div className="w-full md:w-auto flex flex-row justify-between items-center md:block md:mt-0">
          {/* Navigation links */}
          <nav className="flex flex-row gap-4 md:flex-col md:space-y-1 group/nav">
            <a
