...
function FooterLink({ href, label, ariaLabel, external = false }: FooterLinkProps) {
  return (
    <a
      ...
      className="group/link inline-flex items-center gap-1 text-xs text-muted-foreground/40 md:group-hover/nav:text-muted-foreground/30 md:hover:!text-muted-foreground/70 leading-[1.5] visited:text-muted-foreground/40 active:text-muted-foreground/60 focus:text-muted-foreground/40 focus:outline-none"
