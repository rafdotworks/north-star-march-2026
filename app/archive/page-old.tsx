...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const slideshowTimer = setTimeout(() => {
      if (!isNotesModalOpen && !isAllNotesModalOpen && !isSlideshowPaused) {
    ...
    // Set critical content loaded immediately for desktop
    const criticalContentTimer = setTimeout(() => {
    ...
    return () => {
      ...
      clearTimeout(criticalContentTimer);
      if (weatherTimeout) {
  ...
  useEffect(() => {
    if (mounted) {
      ...
      initialImages.slice(0, 3).forEach((src) => {
                ...
                >
                  <div className="w-full">
                    <div className="space-y-8">
                      ...
                      <div className="hidden sm:block w-full mb-0 overflow-hidden relative">
        ...
        >
          <div className="w-full max-w-screen-xl mx-auto relative z-10">
            ...
            {loadingSequence.imagesLoaded && (
              ...
              >
                {/* Desktop: Fixed viewport hero with centered content */}
                <div
                ...
                >
                  <div className="w-full">
                    <div className="space-y-4">
                      ...
                      {/* Simple High-Quality Desktop Carousel */}
                      <div
                        ref={slideshowRef}
                        className="hidden sm:block w-full mb-0 overflow-hidden relative"
                        onMouseEnter={() => {
                          setIsSlideshowPaused(true);
                        }}
                        onMouseLeave={() => {
                            ...
                            >
                              ...
                              >
                                <Image
                                  ...
                                  height={900}
                                  quality={95}
                                  className={`w-full h-auto bg-transparent max-w-full rounded-lg ${
                                    workVideos[src]
                      ...
                      {/* Additional Text Section - After carousel */}
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{
                          duration: 0.5,
                          delay: 3.5, // Start after carousel animation completes
                          ease: [0.22, 1, 0.36, 1],
                        }}
                        className="mt-4"
                      >
                ...
                {/* Mobile: Clean Layout - Work Images First, Text at Bottom */}
                <div className="block sm:hidden">
                  <div className="space-y-16">
                    {/* Mobile Work Images - Individual Scroll */}
                    <div className="space-y-8">
                      {initialImages.map((src: string, index: number) => (
                        <motion.div
                          key={`mobile-simple-${src}`}
                          className="w-full"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{
                ...
                {/* Shared Text Section - Works on both Desktop and Mobile */}
                <div className="w-full pt-8 block sm:hidden">
                  <section className="w-full">
