  ...
  constructor(options?: {
    ...
    super("AsciiEffect", fragmentShader, {
      ...
      uniforms: new Map([
        ...
        ["scanlineCount", new Uniform(postfx.scanlineCount || 300)],
        ...
        ["vignetteIntensity", new Uniform(postfx.vignetteIntensity || 0.4)],

        ["vignetteRadius", new Uniform(postfx.vignetteRadius || 0.7)],

        ["colorPalette", new Uniform(postfx.colorPalette || 0)],

        ["curvature", new Uniform(postfx.curvature || 0.15)],
        ...
        ["brightnessAdjust", new Uniform(postfx.brightnessAdjust || 0.1)],

        ["contrastAdjust", new Uniform(postfx.contrastAdjust || 1.2)],
